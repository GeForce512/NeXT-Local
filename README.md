...
> 👉 **提示：请将下方占位图替换为实际截图或 GIF。README 第一屏的视觉内容对 Star 转化率影响极大。**

| 主界面 — 对话与推理 | 模型管理 — 下载与切换 |
|:---:|:---:|
| ![主界面截图](docs/assets/screenshot-main.png) | ![模型管理截图](docs/assets/screenshot-models.png) |

| LoRA 微调 — 可视化训练 | 工作流 — AI 管线编排 |
|:---:|:---:|
| ![微调界面截图](docs/assets/screenshot-finetune.png) | ![工作流界面截图](docs/assets/screenshot-workflow.png) |
